...
def yükle_7zip():
    try:
        os.system('clear')
        print('\n7zip uygulaması kuruluyor\n')
        os.system('sudo apt-get install p7zip --yes && sudo apt-get install p7zip-full --yes && sudo apt-get install p7zip-rar --yes')
        os.system('clear')
        print('\n7zip uygulaması başarıyla kuruldu\n')
    except:
        os.system('clear')
